...
public class AutoAimCommand extends Command {
  ...
  private PIDController lockToTagXController = new PIDController(0.075, 0.03, 0.005); // 0.075, 0.03, 0.005
  ...
  public AutoAimCommand(SwerveSubsystem swerve, VisionTargetTracker visionTargetTracker, PivotSubsystem pivotSubsystem,
    ...
    this.lockToTagXController = new PIDController(14.0, 0.7, 0.3); // 14.0, 0.7, 0.3
