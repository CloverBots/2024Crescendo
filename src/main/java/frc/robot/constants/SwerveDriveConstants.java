...
public class SwerveDriveConstants {
        ...
        /**
         * The maximum speed of the robot, in meters per second during TeleOp.
         * Use this to limit the speed when using a controller.
         */
        public static final double TELEOP_MAX_SPEED_METERS_PER_SECOND = PHYSICAL_MAX_SPEED_METERS_PER_SECOND;
        public static final double TELEOP_SLOW_SPEED_METERS_PER_SECOND = 2;

        /** Speeds at which the robot can turn. */
        ...
        /** The maximum speed at which the robot can translate in auto. */
        ...
        // Used for position and velocity conversions on the NEO turning motor on the
        // swerve modules.
        ...
        public static enum SwerveModuleConfigurations {
                ...
                private SwerveModuleConfigurations(int driveMotorID, int turnMotorID, int CANCoderID,
        ...
        public static final class PathPlannerSwerve {
                ...
                public static final double maxModuleSpeed = AUTO_MAX_SPEED; // M/S

                public static final HolonomicPathFollowerConfig pathFollowerConfig = new HolonomicPathFollowerConfig(
                                new PIDConstants(5.0, 0, 0), // Translation constants
                                new PIDConstants(0.01, 0, 0), // Rotation constants
                                maxModuleSpeed,
