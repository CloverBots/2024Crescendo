...
public class AutoSubwooferCommand extends ParallelCommandGroup {
  /** Creates a new autoYEETCommand. */
  public AutoSubwooferCommand(IntakeSubsystem intakeSubsystem, PivotSubsystem pivotSubsystem,
