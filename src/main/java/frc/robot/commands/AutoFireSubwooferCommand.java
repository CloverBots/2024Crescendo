...
public class AutoFireSubwooferCommand extends SequentialCommandGroup {
  /** Creates a new AutoFire. */
  public AutoFireSubwooferCommand(FeederSubsystem feederSubsystem, PivotSubsystem pivotSubsystem, ShooterSubsystem shooterSubsystem) {
    addCommands(
